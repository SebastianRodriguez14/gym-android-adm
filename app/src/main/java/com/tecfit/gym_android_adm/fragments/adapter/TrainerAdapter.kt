...
class TrainerAdapter(private val trainerList:List<Trainer>, val listTrainersFragment: ListTrainersFragment) : RecyclerView.Adapter<TrainerViewHolder>(){

    override fun onCreateViewHolder(parent: ViewGroup, viewType:Int):TrainerViewHolder{
        val layoutInflater = LayoutInflater.from(parent.context)
        return TrainerViewHolder(layoutInflater.inflate(R.layout.item_trainers,parent,false), listTrainersFragment)
    }
